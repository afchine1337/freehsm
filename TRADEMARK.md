...
The following names and marks are used by the project and are claimed as
trademarks (common-law / unregistered unless stated otherwise) by
...
* The tagline **"Open Source Cryptography and Digital Trust"**
...
The Apache-2.0 license does **not** grant rights to the names, logos, or
wordmarks above (see Apache-2.0 §6, Trademarks). The logo and wordmark
artwork files are **not** Apache-2.0; they are © Simorgh Labs, all rights
reserved.
...
* Use the logo, wordmark, or tagline as (part of) **your own product name,
  logo, domain name, or company name**.
* Alter the logo (recolor, restyle, remove the Persian script in cultural
  contexts) — see the brand usage rules in
  `SIMORGH_LABS_BRAND_REFERENCE.md` (internal).

## Certification claims

FIPS 140-3 and Common Criteria certification statuses refer to specific,
identified builds and submissions by Simorgh Labs. You may not represent a
rebuilt or modified binary as covered by any Simorgh Labs certification,
