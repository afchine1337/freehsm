...
# The optional key-wrap IV of PKCS#11 v3.2 §6.16.2, on all four entry points.
# It was accepted and dropped; a caller supplying one got the default (#14).
tests/test_kw_iv: tests/test_kw_iv.c $(LIB)
	$(CC) $(CFLAGS) -o $@ $< -ldl
